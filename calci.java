public class Calci extends extendedCalculator {
    ...
    public static void main(String[] args){
        ...
        float square_result = calc.square(operand_1); // Now accessible from extendedCalculator
        System.out.println("Result of square is: " + square_result);
        float cube_result = calc.cube(operand_1); // Now accessible from extendedCalculator
